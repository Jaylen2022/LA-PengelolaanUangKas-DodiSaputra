<?php 
  ...
  checkLogin();
  $jml_pegawai = mysqli_fetch_assoc(mysqli_query($conn, "SELECT count(id_pegawai) as jml_pegawai FROM pegawai"));
  $jml_pegawai = $jml_pegawai['jml_pegawai'];
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="card shadow">
              <div class="card-body">
                <h5><i class="fas fa-fw fa-user-tie"></i> Pegawai</h5>
                <h6 class="text-muted">Jumlah Pegawai: <?= $jml_pegawai; ?></h6>
                <a href="pegawai.php" class="btn btn-info"><i class="fas fa-fw fa-align-justify"></i></a>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
